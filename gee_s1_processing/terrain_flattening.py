...
def im_slope_correction(
    im: Image, TERRAIN_FLATTENING_MODEL, DEM, TERRAIN_FLATTENING_ADDITIONAL_LAYOVER_SHADOW_BUFFER
):
    """
    ...
    -------
    ee image
        An image where radiometric terrain normalization is
        implemented
